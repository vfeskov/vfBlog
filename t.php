...
fwrite($f, json_encode('<p>There are numerous great tools for asynchronous file upload, one of them is <a href="http://blueimp.github.com/jQuery-File-Upload/" target="_blank">jQuery File Upload</a>. It has a lot of options and can be used in almost any scenario, however, in most cases you won\'t be using all the features and sometimes it\'s easier to make a specific implementation corresponding to your exact requirements. The tool also does not provide a progress bar for IE9 and earlier. </p>
                        ...
                        <pre><code class="javascript">iframeUpload = function(){};
                        ...
                        <pre><code class="javascript">iframeUpload.started = function() {
                            jQuery(\'#response\').removeClass().addClass(\'loading\').html(\'Loading, please wait.\').show();
                            jQuery(\'form\').hide();
                        }</code></pre>
                        ...
                        <pre><code class="javascript">iframeUpload.complete = function(){
                            jQuery(\'form\').show();
                            var response = jQuery("iframe").contents().text();
                            if(response){
                                response = jQuery.parseJSON(response);
                        ...
                        <pre><code class="javascript">xmlhttprequestUpload = function(){};
                        xmlhttprequestUpload.init = function() {
                            jQuery(\'form\').on(\'submit\',xmlhttprequestUpload.started);
                        }
                        xmlhttprequestUpload.started = function(e) {
                        ...
                        xmlhttprequestUpload.progress = function(e){
                            var done = e.position || e.loaded;
                            var total = e.totalSize || e.total;
                            jQuery(\'.progress-bar\').css(\'width\',(Math.floor(done/total*1000)/10) + \'%\');
                        }
                        xmlhttprequestUpload.complete = function(){
                            jQuery(\'form\').show();
                        ...
                        <pre><code class="javascript">flashUpload = function(){};
                        flashUpload.init = function() {
                        ...
                        flashUpload.started = function(e) {
                        ...
                        flashUpload.progress = function(file, bytesLoaded, bytesTotal){
                            jQuery(\'.progress-bar\').css(\'width\',(Math.floor(bytesLoaded/bytesTotal*1000)/10) + \'%\');
                        }
                        flashUpload.complete = function(){
                            jQuery(\'form\').show();
                            jQuery(\'#response\').removeClass()
                                .addClass(\'success\')
                                .html(\'Success!\').show();
                        }
                        flashUpload.error = function(file, errorCode, message){
